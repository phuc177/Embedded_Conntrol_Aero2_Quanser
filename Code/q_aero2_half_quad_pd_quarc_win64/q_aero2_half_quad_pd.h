...
typedef struct {
  ...
  real_T Product1_i;                   /* '<S4>/Product1' */
  real_T Product1_m;                   /* '<S5>/Product1' */
  real_T u4V;                          /* '<Root>/+//- 24V' */
  real_T Forveresponse;                /* '<Root>/For +ve  response' */
  real_T Gain;                         /* '<S3>/Gain' */
  real_T Product;                      /* '<S4>/Product' */
  real_T Product_b;                    /* '<S5>/Product' */
...
typedef struct {
  ...
  real_T LastUAtTimeA_k;               /* '<S1>/Derivative1' */
  real_T TimeStampB_m;                 /* '<S1>/Derivative1' */
  real_T LastUAtTimeB_g;               /* '<S1>/Derivative1' */
  ...
  boolean_T Integrator1_DWORK1_h;      /* '<S5>/Integrator1' */
...
typedef struct {
  ...
  real_T Integrator2_CSTATE_h;         /* '<S5>/Integrator2' */
...
typedef struct {
  ...
  boolean_T Integrator2_CSTATE_h;      /* '<S5>/Integrator2' */
...
struct P_q_aero2_half_quad_pd_T_ {
  real_T Controller_Ki;                /* Mask Parameter: Controller_Ki
                                        * Referenced by: '<S1>/Ki'
                                        */
  real_T Controller_Kp;                /* Mask Parameter: Controller_Kp
                                        * Referenced by: '<S1>/Kp'
                                        */
  real_T Controller_Kv;                /* Mask Parameter: Controller_Kv
                                        * Referenced by: '<S1>/Kv'
                                        */
  real_T Controller_Wn;                /* Mask Parameter: Controller_Wn
                                        * Referenced by: '<S1>/Wn'
                                        */
  ...
  real_T Gain_Gain;                    /* Expression: 180/pi
                                        ...
                                        */
  real_T Damping_Value;                /* Expression: 1
 ...
 * '<S1>'   : 'q_aero2_half_quad_pd/Controller'
 * '<S2>'   : 'q_aero2_half_quad_pd/Degrees to Radians1'
 * '<S3>'   : 'q_aero2_half_quad_pd/Radians to Degrees'
 * '<S4>'   : 'q_aero2_half_quad_pd/Controller/Second-Order Low-Pass Filter for Error'
 * '<S5>'   : 'q_aero2_half_quad_pd/Controller/Second-Order Low-Pass Filter for Velocity'
 */
