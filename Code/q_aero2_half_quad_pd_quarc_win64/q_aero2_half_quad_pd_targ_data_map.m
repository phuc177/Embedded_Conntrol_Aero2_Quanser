    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% q_aero2_half_quad_pd_P.Controller_Ki
            ...
            section.data(34)  = dumData; %prealloc
                    ...
                    ;% q_aero2_half_quad_pd_P.Ka_Value
                    ...
                    ;% q_aero2_half_quad_pd_P.Kd_Value
                    ...
                    ;% q_aero2_half_quad_pd_P.Damping_Value
                    section.data(32).logicalSrcIdx = 36;
                    section.data(32).dtTransOffset = 37;

                    ;% q_aero2_half_quad_pd_P.Constant_Value
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(14)  = dumData; %prealloc
                    ...
                    ;% q_aero2_half_quad_pd_B.Derivative
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 3;
                    ...
                    ;% q_aero2_half_quad_pd_B.e
                    section.data(6).logicalSrcIdx = 5;
                    section.data(6).dtTransOffset = 5;

                    ;% q_aero2_half_quad_pd_B.Product1
                    section.data(7).logicalSrcIdx = 6;
                    section.data(7).dtTransOffset = 6;

                    ;% q_aero2_half_quad_pd_B.Product1_i
                    section.data(8).logicalSrcIdx = 7;
                    section.data(8).dtTransOffset = 7;

                    ;% q_aero2_half_quad_pd_B.Product1_m
                    ...
                    ;% q_aero2_half_quad_pd_B.Product
                    section.data(13).logicalSrcIdx = 12;
                    section.data(13).dtTransOffset = 12;

                    ;% q_aero2_half_quad_pd_B.Product_b
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(15)  = dumData; %prealloc
                    ...
                    ;% q_aero2_half_quad_pd_DW.TimeStampA
                    section.data(7).logicalSrcIdx = 6;
                    section.data(7).dtTransOffset = 14;

                    ;% q_aero2_half_quad_pd_DW.LastUAtTimeA
                    section.data(8).logicalSrcIdx = 7;
                    section.data(8).dtTransOffset = 15;
                    ...
                    ;% q_aero2_half_quad_pd_DW.LastUAtTimeB
                    section.data(10).logicalSrcIdx = 9;
                    section.data(10).dtTransOffset = 17;

                    ;% q_aero2_half_quad_pd_DW.TimeStampA_a
                    section.data(11).logicalSrcIdx = 10;
                    section.data(11).dtTransOffset = 18;

                    ;% q_aero2_half_quad_pd_DW.LastUAtTimeA_k
                    section.data(12).logicalSrcIdx = 11;
                    ...
                    ;% q_aero2_half_quad_pd_DW.LastUAtTimeB_g
                    section.data(14).logicalSrcIdx = 13;
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% q_aero2_half_quad_pd_DW.Integrator1_DWORK1
                    section.data(2).logicalSrcIdx = 31;
                    section.data(2).dtTransOffset = 2;

                    ;% q_aero2_half_quad_pd_DW.Integrator1_DWORK1_h
    ...
    targMap.checksum0 = 3408898864;
    targMap.checksum1 = 981065413;
    targMap.checksum2 = 171580317;
    targMap.checksum3 = 245212639;
