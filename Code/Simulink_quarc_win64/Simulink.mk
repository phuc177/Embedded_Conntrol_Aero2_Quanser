...
## Generated on : Tue Jun 30 13:40:39 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Simulink.rt-win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Simulink.rt-win64
...
DEFINES_STANDARD = -DMODEL=Simulink -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Simulink_quarc_win64\Simulink.c $(START_DIR)\Simulink_quarc_win64\Simulink_data.c $(START_DIR)\Simulink_quarc_win64\Simulink_main.c $(START_DIR)\Simulink_quarc_win64\rtGetInf.c $(START_DIR)\Simulink_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Simulink.obj Simulink_data.obj Simulink_main.obj rtGetInf.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Simulink_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Simulink_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Simulink.obj : "$(START_DIR)\Simulink_quarc_win64\Simulink.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Simulink_quarc_win64\Simulink.c"


Simulink_data.obj : "$(START_DIR)\Simulink_quarc_win64\Simulink_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Simulink_quarc_win64\Simulink_data.c"


Simulink_main.obj : "$(START_DIR)\Simulink_quarc_win64\Simulink_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Simulink_quarc_win64\Simulink_main.c"


rtGetInf.obj : "$(START_DIR)\Simulink_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Simulink_quarc_win64\rtGetInf.c"


rt_nonfinite.obj : "$(START_DIR)\Simulink_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Simulink_quarc_win64\rt_nonfinite.c"
