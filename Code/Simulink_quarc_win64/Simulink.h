...
#define Simulink_rtModel               RT_MODEL_Simulink_T

/* Block signals (default storage) */
typedef struct {
  real_T Gain1;                        /* '<Root>/Gain1' */
  real_T Derivative;                   /* '<Root>/Derivative' */
  real_T DerivLPF;                     /* '<Root>/Deriv + LPF' */
  real_T LPF;                          /* '<Root>/LPF' */
  real_T Realspeed;                    /* '<Root>/Gain3' */
...
typedef struct {
  ...
  real_T TimeStampA_o;                 /* '<Root>/Derivative1' */
  real_T LastUAtTimeA_k;               /* '<Root>/Derivative1' */
  real_T TimeStampB_g;                 /* '<Root>/Derivative1' */
  real_T LastUAtTimeB_o;               /* '<Root>/Derivative1' */
  ...
  struct {
    void *LoggedData[4];
  } Speedestimation_PWORK;             /* '<Root>/Speed estimation' */
...
typedef struct {
  real_T DerivLPF_CSTATE;              /* '<Root>/Deriv + LPF' */
...
/* State disabled  */
typedef struct {
  boolean_T DerivLPF_CSTATE;           /* '<Root>/Deriv + LPF' */
...
#define rtB                            Simulink_B
#define BlockIO                        B_Simulink_T
#define rtX                            Simulink_X
#define ContinuousStates               X_Simulink_T
#define rtXdot                         Simulink_XDot
#define StateDerivatives               XDot_Simulink_T
#define tXdis                          Simulink_XDis
#define StateDisabled                  XDis_Simulink_T
#define rtP                            Simulink_P
#define Parameters                     P_Simulink_T
#define rtDWork                        Simulink_DW
#define D_Work                         DW_Simulink_T

/* Parameters (default storage) */
struct P_Simulink_T_ {
  ...
  real_T Gain1_Gain;                   /* Expression: 2*pi/4096
                                        ...
                                        */
  real_T DerivLPF_A;                   /* Computed Parameter: DerivLPF_A
                                        * Referenced by: '<Root>/Deriv + LPF'
                                        */
  real_T DerivLPF_C;                   /* Computed Parameter: DerivLPF_C
                                        * Referenced by: '<Root>/Deriv + LPF'
                                        */
  real_T DerivLPF_D;                   /* Computed Parameter: DerivLPF_D
                                        * Referenced by: '<Root>/Deriv + LPF'
                                        */
  ...
  real_T LPF_C;                        /* Computed Parameter: LPF_C
                                        * Referenced by: '<Root>/LPF'
                                        */
  real_T Gain3_Gain;                   /* Expression: 2*pi/4096
                                        * Referenced by: '<Root>/Gain3'
                                        */
  real_T Gain2_Gain;                   /* Expression: 360/(2*pi)
...
extern P_Simulink_T Simulink_P;

/* Block signals (default storage) */
extern B_Simulink_T Simulink_B;

/* Continuous states (default storage) */
extern X_Simulink_T Simulink_X;

/* Disabled states (default storage) */
extern XDis_Simulink_T Simulink_XDis;

/* Block states (default storage) */
extern DW_Simulink_T Simulink_DW;

/* Model entry point functions */
extern void Simulink_initialize(void);
extern void Simulink_output(void);
extern void Simulink_update(void);
extern void Simulink_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Simulink_rtModel *Simulink(void);
...
extern RT_MODEL_Simulink_T *const Simulink_M;
