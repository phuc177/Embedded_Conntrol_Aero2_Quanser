###########################################################################
## Makefile generated for component 'q_aero2_half_quad_model'. 
## 
## Makefile     : q_aero2_half_quad_model.mk
## Generated on : Tue Jun 30 14:01:13 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_aero2_half_quad_model.rt-win64
...
PRODUCT_NAME              = q_aero2_half_quad_model
MAKEFILE                  = q_aero2_half_quad_model.mk
...
COMPILER_COMMAND_FILE     = q_aero2_half_quad_model_comp.rsp
CMD_FILE                  = q_aero2_half_quad_model.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_aero2_half_quad_model.rt-win64
...
DEFINES_STANDARD = -DMODEL=q_aero2_half_quad_model -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\q_aero2_half_quad_model_quarc_win64\q_aero2_half_quad_model.c $(START_DIR)\q_aero2_half_quad_model_quarc_win64\q_aero2_half_quad_model_data.c $(START_DIR)\q_aero2_half_quad_model_quarc_win64\q_aero2_half_quad_model_main.c $(START_DIR)\q_aero2_half_quad_model_quarc_win64\rtGetInf.c $(START_DIR)\q_aero2_half_quad_model_quarc_win64\rtGetNaN.c $(START_DIR)\q_aero2_half_quad_model_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = q_aero2_half_quad_model.obj q_aero2_half_quad_model_data.obj q_aero2_half_quad_model_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\q_aero2_half_quad_model_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_aero2_half_quad_model_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_aero2_half_quad_model.obj : "$(START_DIR)\q_aero2_half_quad_model_quarc_win64\q_aero2_half_quad_model.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_aero2_half_quad_model_quarc_win64\q_aero2_half_quad_model.c"


q_aero2_half_quad_model_data.obj : "$(START_DIR)\q_aero2_half_quad_model_quarc_win64\q_aero2_half_quad_model_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_aero2_half_quad_model_quarc_win64\q_aero2_half_quad_model_data.c"


q_aero2_half_quad_model_main.obj : "$(START_DIR)\q_aero2_half_quad_model_quarc_win64\q_aero2_half_quad_model_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_aero2_half_quad_model_quarc_win64\q_aero2_half_quad_model_main.c"


rtGetInf.obj : "$(START_DIR)\q_aero2_half_quad_model_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_aero2_half_quad_model_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\q_aero2_half_quad_model_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_aero2_half_quad_model_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\q_aero2_half_quad_model_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_aero2_half_quad_model_quarc_win64\rt_nonfinite.c"
