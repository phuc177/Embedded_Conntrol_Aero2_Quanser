...
#ifndef q_aero2_half_quad_model_h_
#define q_aero2_half_quad_model_h_
#ifndef q_aero2_half_quad_model_COMMON_INCLUDES_
#define q_aero2_half_quad_model_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                            /* q_aero2_half_quad_model_COMMON_INCLUDES_ */

#include "q_aero2_half_quad_model_types.h"
...
#define q_aero2_half_quad_model_rtModel RT_MODEL_q_aero2_half_quad_mo_T

/* Block signals (default storage) */
typedef struct {
  real_T motorvoltage;                 /* '<Root>/Gain' */
  real_T Forveresponse;                /* '<Root>/For +ve  response' */
  real_T rearrotorspeed;               /* '<Root>/Counts//s to rad//s' */
  real_T yawangle;                     /* '<Root>/counts to rad' */
  real_T yawrate;                      /* '<Root>/Transfer Fcn' */
  real_T Countstorads;                 /* '<Root>/Counts to rad//s' */
} B_q_aero2_half_quad_model_T;
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Rotorrads_PWORK;                   /* '<Root>/Rotor (rad//s)' */

  void *ToHostFile_PWORK[2];           /* '<Root>/To Host File' */
  struct {
    void *LoggedData;
  } YawAnglerad_PWORK;                 /* '<Root>/Yaw Angle (rad)' */
...
} DW_q_aero2_half_quad_model_T;

/* Continuous states (default storage) */
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} X_q_aero2_half_quad_model_T;

/* State derivatives (default storage) */
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} XDot_q_aero2_half_quad_model_T;

/* State disabled  */
typedef struct {
  boolean_T TransferFcn_CSTATE;        /* '<Root>/Transfer Fcn' */
} XDis_q_aero2_half_quad_model_T;
...
#define rtB                            q_aero2_half_quad_model_B
#define BlockIO                        B_q_aero2_half_quad_model_T
#define rtX                            q_aero2_half_quad_model_X
#define ContinuousStates               X_q_aero2_half_quad_model_T
#define rtXdot                         q_aero2_half_quad_model_XDot
#define StateDerivatives               XDot_q_aero2_half_quad_model_T
#define tXdis                          q_aero2_half_quad_model_XDis
#define StateDisabled                  XDis_q_aero2_half_quad_model_T
#define rtP                            q_aero2_half_quad_model_P
#define Parameters                     P_q_aero2_half_quad_model_T
#define rtDWork                        q_aero2_half_quad_model_DW
#define D_Work                         DW_q_aero2_half_quad_model_T

/* Parameters (default storage) */
struct P_q_aero2_half_quad_model_T_ {
  ...
  uint8_T HILReadTimebase_OverflowMode;
                              ...
                              * Referenced by: '<Root>/HIL Read Timebase'
                              */
  uint8_T ToHostFile_VarName[18];      /* Expression: variable_name_argument
                                        * Referenced by: '<Root>/To Host File'
                                        */
...
extern P_q_aero2_half_quad_model_T q_aero2_half_quad_model_P;

/* Block signals (default storage) */
extern B_q_aero2_half_quad_model_T q_aero2_half_quad_model_B;

/* Continuous states (default storage) */
extern X_q_aero2_half_quad_model_T q_aero2_half_quad_model_X;

/* Disabled states (default storage) */
extern XDis_q_aero2_half_quad_model_T q_aero2_half_quad_model_XDis;

/* Block states (default storage) */
extern DW_q_aero2_half_quad_model_T q_aero2_half_quad_model_DW;

/* Model entry point functions */
extern void q_aero2_half_quad_model_initialize(void);
extern void q_aero2_half_quad_model_output(void);
extern void q_aero2_half_quad_model_update(void);
extern void q_aero2_half_quad_model_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_aero2_half_quad_model_rtModel *q_aero2_half_quad_model(void);
...
extern RT_MODEL_q_aero2_half_quad_mo_T *const q_aero2_half_quad_model_M;
 ...
 *
 * '<Root>' : 'q_aero2_half_quad_model'
 */
#endif                                 /* q_aero2_half_quad_model_h_ */
