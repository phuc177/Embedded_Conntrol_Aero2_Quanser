...
void q_aero2_half_quad_pd_output(void)
{
   ...
   *  Sum: '<Root>/Sum1'
   *  TransferFcn: '<Root>/R//S Fcn'
   *  TransferFcn: '<Root>/T//S Fcn'
   */
  u0 = ((q_aero2_half_quad_pd_P.TSFcn_C[0] *
         q_aero2_half_quad_pd_X.TSFcn_CSTATE[0] +
         q_aero2_half_quad_pd_P.TSFcn_C[1] *
         q_aero2_half_quad_pd_X.TSFcn_CSTATE[1]) -
        ((q_aero2_half_quad_pd_P.RSFcn_C[0] *
          q_aero2_half_quad_pd_X.RSFcn_CSTATE[0] +
          q_aero2_half_quad_pd_P.RSFcn_C[1] *
          q_aero2_half_quad_pd_X.RSFcn_CSTATE[1]) +
         q_aero2_half_quad_pd_P.RSFcn_D * q_aero2_half_quad_pd_B.yaw)) +
    q_aero2_half_quad_pd_B.DisturbanceSwitch;

  /* Saturate: '<Root>/+//- 24V' */
  if (u0 > q_aero2_half_quad_pd_P.u4V_UpperSat) {
    /* Saturate: '<Root>/+//- 24V' */
    q_aero2_half_quad_pd_B.u4V = q_aero2_half_quad_pd_P.u4V_UpperSat;
  } else if (u0 < q_aero2_half_quad_pd_P.u4V_LowerSat) {
    /* Saturate: '<Root>/+//- 24V' */
    q_aero2_half_quad_pd_B.u4V = q_aero2_half_quad_pd_P.u4V_LowerSat;
  } else {
    /* Saturate: '<Root>/+//- 24V' */
    q_aero2_half_quad_pd_B.u4V = u0;
  }
...
void q_aero2_half_quad_pd_derivatives(void)
{
  ...
  /* Derivatives for TransferFcn: '<Root>/T//S Fcn' */
  _rtXdot->TSFcn_CSTATE[0] = q_aero2_half_quad_pd_P.TSFcn_A[0] *
    q_aero2_half_quad_pd_X.TSFcn_CSTATE[0];
  _rtXdot->TSFcn_CSTATE[0] += q_aero2_half_quad_pd_P.TSFcn_A[1] *
    q_aero2_half_quad_pd_X.TSFcn_CSTATE[1];
  _rtXdot->TSFcn_CSTATE[1] = q_aero2_half_quad_pd_X.TSFcn_CSTATE[0];
  _rtXdot->TSFcn_CSTATE[0] += q_aero2_half_quad_pd_B.Gain1;

  /* Derivatives for TransferFcn: '<Root>/R//S Fcn' */
  _rtXdot->RSFcn_CSTATE[0] = q_aero2_half_quad_pd_P.RSFcn_A[0] *
    q_aero2_half_quad_pd_X.RSFcn_CSTATE[0];
  _rtXdot->RSFcn_CSTATE[0] += q_aero2_half_quad_pd_P.RSFcn_A[1] *
    q_aero2_half_quad_pd_X.RSFcn_CSTATE[1];
  _rtXdot->RSFcn_CSTATE[1] = q_aero2_half_quad_pd_X.RSFcn_CSTATE[0];
  _rtXdot->RSFcn_CSTATE[0] += q_aero2_half_quad_pd_B.yaw;
}
...
void q_aero2_half_quad_pd_initialize(void)
{
  ...
  /* InitializeConditions for TransferFcn: '<Root>/T//S Fcn' */
  q_aero2_half_quad_pd_X.TSFcn_CSTATE[0] = 0.0;

  /* InitializeConditions for TransferFcn: '<Root>/R//S Fcn' */
  q_aero2_half_quad_pd_X.RSFcn_CSTATE[0] = 0.0;

  /* InitializeConditions for TransferFcn: '<Root>/T//S Fcn' */
  q_aero2_half_quad_pd_X.TSFcn_CSTATE[1] = 0.0;

  /* InitializeConditions for TransferFcn: '<Root>/R//S Fcn' */
  q_aero2_half_quad_pd_X.RSFcn_CSTATE[1] = 0.0;
}
...
RT_MODEL_q_aero2_half_quad_pd_T *q_aero2_half_quad_pd(void)
{
  ...
  /* External mode info */
  q_aero2_half_quad_pd_M->Sizes.checksums[0] = (3905929676U);
  q_aero2_half_quad_pd_M->Sizes.checksums[1] = (3073422186U);
  q_aero2_half_quad_pd_M->Sizes.checksums[2] = (2643057006U);
  q_aero2_half_quad_pd_M->Sizes.checksums[3] = (1682152709U);
  ...
  /* Initialize Sizes */
  q_aero2_half_quad_pd_M->Sizes.numContStates = (4);/* Number of continuous states */
  ...
  q_aero2_half_quad_pd_M->Sizes.numBlocks = (22);/* Number of blocks */
  q_aero2_half_quad_pd_M->Sizes.numBlockIO = (7);/* Number of block outputs */
  q_aero2_half_quad_pd_M->Sizes.numBlockPrms = (139);/* Sum of parameter "widths" */
