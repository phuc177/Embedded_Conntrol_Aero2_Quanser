...
void q_aero2_half_quad_model_val_output(void)
{
  ...
  q_aero2_half_quad_model_val_B.model +=
    ...
    q_aero2_half_quad_model_val_X.TransferFcn1_CSTATE;
  if (tmp) {
...
void q_aero2_half_quad_model_val_derivatives(void)
{
  ...
  _rtXdot->TransferFcn1_CSTATE = q_aero2_half_quad_model_val_P.TransferFcn1_A *
    q_aero2_half_quad_model_val_X.TransferFcn1_CSTATE;
  _rtXdot->TransferFcn1_CSTATE += q_aero2_half_quad_model_val_B.Gain;
}
...
void q_aero2_half_quad_model_val_initialize(void)
{
  ...
  q_aero2_half_quad_model_val_X.TransferFcn1_CSTATE = 0.0;
}
...
RT_MODEL_q_aero2_half_quad_mo_T *q_aero2_half_quad_model_val(void)
{
  ...
  /* External mode info */
  q_aero2_half_quad_model_val_M->Sizes.checksums[0] = (1040034854U);
  q_aero2_half_quad_model_val_M->Sizes.checksums[1] = (2864630388U);
  q_aero2_half_quad_model_val_M->Sizes.checksums[2] = (1317902855U);
  q_aero2_half_quad_model_val_M->Sizes.checksums[3] = (995295079U);
  ...
  /* Initialize Sizes */
  q_aero2_half_quad_model_val_M->Sizes.numContStates = (2);/* Number of continuous states */
  ...
  q_aero2_half_quad_model_val_M->Sizes.numBlocks = (14);/* Number of blocks */
  q_aero2_half_quad_model_val_M->Sizes.numBlockIO = (7);/* Number of block outputs */
  q_aero2_half_quad_model_val_M->Sizes.numBlockPrms = (143);/* Sum of parameter "widths" */
