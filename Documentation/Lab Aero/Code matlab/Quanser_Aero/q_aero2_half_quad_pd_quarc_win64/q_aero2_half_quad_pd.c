 ...
 * C source code generated on : Wed Jul  1 16:29:59 2026
 *
...
void q_aero2_half_quad_pd_output(void)
{
   ...
   *  TransferFcn: '<Root>/R//S1'
   */
  rtb_TS = ((q_aero2_half_quad_pd_P.RS1_C[0] *
             q_aero2_half_quad_pd_X.RS1_CSTATE[0] +
             q_aero2_half_quad_pd_P.RS1_C[1] *
             q_aero2_half_quad_pd_X.RS1_CSTATE[1]) +
            q_aero2_half_quad_pd_P.RS1_C[2] * q_aero2_half_quad_pd_X.RS1_CSTATE
            [2]) + q_aero2_half_quad_pd_B.DisturbanceSwitch;

  /* Saturate: '<Root>/+//- 24V' */
  if (rtb_TS > q_aero2_half_quad_pd_P.u4V_UpperSat) {
    /* Saturate: '<Root>/+//- 24V' */
    q_aero2_half_quad_pd_B.u4V = q_aero2_half_quad_pd_P.u4V_UpperSat;
  } else if (rtb_TS < q_aero2_half_quad_pd_P.u4V_LowerSat) {
    /* Saturate: '<Root>/+//- 24V' */
    q_aero2_half_quad_pd_B.u4V = q_aero2_half_quad_pd_P.u4V_LowerSat;
  } else {
    /* Saturate: '<Root>/+//- 24V' */
    q_aero2_half_quad_pd_B.u4V = rtb_TS;
  }
  ...
  /* TransferFcn: '<Root>/2nd ord sys' */
  q_aero2_half_quad_pd_B.undordsys = q_aero2_half_quad_pd_P.undordsys_C[0] *
    q_aero2_half_quad_pd_X.undordsys_CSTATE[0];
  q_aero2_half_quad_pd_B.undordsys += q_aero2_half_quad_pd_P.undordsys_C[1] *
    q_aero2_half_quad_pd_X.undordsys_CSTATE[1];

  /* Sum: '<Root>/Sum1' incorporates:
   *  TransferFcn: '<Root>/T//S'
   */
  q_aero2_half_quad_pd_B.Sum1 = (q_aero2_half_quad_pd_P.TS_C[0] *
    q_aero2_half_quad_pd_X.TS_CSTATE[0] + q_aero2_half_quad_pd_P.TS_C[1] *
    q_aero2_half_quad_pd_X.TS_CSTATE[1]) - q_aero2_half_quad_pd_B.yaw;
}
...
void q_aero2_half_quad_pd_derivatives(void)
{
  ...
  /* Derivatives for TransferFcn: '<Root>/R//S1' */
  _rtXdot->RS1_CSTATE[0] = q_aero2_half_quad_pd_P.RS1_A[0] *
    q_aero2_half_quad_pd_X.RS1_CSTATE[0];
  _rtXdot->RS1_CSTATE[0] += q_aero2_half_quad_pd_P.RS1_A[1] *
    q_aero2_half_quad_pd_X.RS1_CSTATE[1];
  _rtXdot->RS1_CSTATE[0] += q_aero2_half_quad_pd_P.RS1_A[2] *
    q_aero2_half_quad_pd_X.RS1_CSTATE[2];
  _rtXdot->RS1_CSTATE[0] += q_aero2_half_quad_pd_B.Sum1;
  _rtXdot->RS1_CSTATE[1] = q_aero2_half_quad_pd_X.RS1_CSTATE[0];

  /* Derivatives for TransferFcn: '<Root>/2nd ord sys' */
  _rtXdot->undordsys_CSTATE[0] = q_aero2_half_quad_pd_P.undordsys_A[0] *
    q_aero2_half_quad_pd_X.undordsys_CSTATE[0];

  /* Derivatives for TransferFcn: '<Root>/R//S1' */
  _rtXdot->RS1_CSTATE[2] = q_aero2_half_quad_pd_X.RS1_CSTATE[1];

  /* Derivatives for TransferFcn: '<Root>/2nd ord sys' */
  _rtXdot->undordsys_CSTATE[0] += q_aero2_half_quad_pd_P.undordsys_A[1] *
    q_aero2_half_quad_pd_X.undordsys_CSTATE[1];
  _rtXdot->undordsys_CSTATE[1] = q_aero2_half_quad_pd_X.undordsys_CSTATE[0];
  _rtXdot->undordsys_CSTATE[0] += q_aero2_half_quad_pd_B.Gain1;

  /* Derivatives for TransferFcn: '<Root>/T//S' */
  _rtXdot->TS_CSTATE[0] = q_aero2_half_quad_pd_P.TS_A[0] *
    q_aero2_half_quad_pd_X.TS_CSTATE[0];
  _rtXdot->TS_CSTATE[0] += q_aero2_half_quad_pd_P.TS_A[1] *
    q_aero2_half_quad_pd_X.TS_CSTATE[1];
  _rtXdot->TS_CSTATE[1] = q_aero2_half_quad_pd_X.TS_CSTATE[0];
  _rtXdot->TS_CSTATE[0] += q_aero2_half_quad_pd_B.undordsys;

  /* Derivatives for TransferFcn: '<Root>/R//S2' */
  _rtXdot->RS2_CSTATE[0] = q_aero2_half_quad_pd_P.RS2_A[0] *
    q_aero2_half_quad_pd_X.RS2_CSTATE[0];
  _rtXdot->RS2_CSTATE[0] += q_aero2_half_quad_pd_P.RS2_A[1] *
    q_aero2_half_quad_pd_X.RS2_CSTATE[1];
  _rtXdot->RS2_CSTATE[0] += q_aero2_half_quad_pd_P.RS2_A[2] *
    q_aero2_half_quad_pd_X.RS2_CSTATE[2];
  _rtXdot->RS2_CSTATE[1] = q_aero2_half_quad_pd_X.RS2_CSTATE[0];

  /* Derivatives for TransferFcn: '<Root>/T//S1' */
  _rtXdot->TS1_CSTATE[0] = q_aero2_half_quad_pd_P.TS1_A[0] *
    q_aero2_half_quad_pd_X.TS1_CSTATE[0];

  /* Derivatives for TransferFcn: '<Root>/R//S2' */
  _rtXdot->RS2_CSTATE[2] = q_aero2_half_quad_pd_X.RS2_CSTATE[1];

  /* Derivatives for TransferFcn: '<Root>/T//S1' */
  _rtXdot->TS1_CSTATE[0] += q_aero2_half_quad_pd_P.TS1_A[1] *
    q_aero2_half_quad_pd_X.TS1_CSTATE[1];
  _rtXdot->TS1_CSTATE[1] = q_aero2_half_quad_pd_X.TS1_CSTATE[0];
}
...
void q_aero2_half_quad_pd_initialize(void)
{
  ...
  /* InitializeConditions for TransferFcn: '<Root>/R//S1' */
  q_aero2_half_quad_pd_X.RS1_CSTATE[0] = 0.0;
  q_aero2_half_quad_pd_X.RS1_CSTATE[1] = 0.0;
  q_aero2_half_quad_pd_X.RS1_CSTATE[2] = 0.0;

  /* InitializeConditions for TransferFcn: '<Root>/2nd ord sys' */
  q_aero2_half_quad_pd_X.undordsys_CSTATE[0] = 0.0;

  /* InitializeConditions for TransferFcn: '<Root>/T//S' */
  q_aero2_half_quad_pd_X.TS_CSTATE[0] = 0.0;

  /* InitializeConditions for TransferFcn: '<Root>/2nd ord sys' */
  q_aero2_half_quad_pd_X.undordsys_CSTATE[1] = 0.0;

  /* InitializeConditions for TransferFcn: '<Root>/T//S' */
  q_aero2_half_quad_pd_X.TS_CSTATE[1] = 0.0;

  /* InitializeConditions for TransferFcn: '<Root>/R//S2' */
  q_aero2_half_quad_pd_X.RS2_CSTATE[0] = 0.0;
  q_aero2_half_quad_pd_X.RS2_CSTATE[1] = 0.0;
  q_aero2_half_quad_pd_X.RS2_CSTATE[2] = 0.0;

  /* InitializeConditions for TransferFcn: '<Root>/T//S1' */
  q_aero2_half_quad_pd_X.TS1_CSTATE[0] = 0.0;
  q_aero2_half_quad_pd_X.TS1_CSTATE[1] = 0.0;
}
...
RT_MODEL_q_aero2_half_quad_pd_T *q_aero2_half_quad_pd(void)
{
  ...
  /* External mode info */
  q_aero2_half_quad_pd_M->Sizes.checksums[0] = (2203758865U);
  q_aero2_half_quad_pd_M->Sizes.checksums[1] = (1379812737U);
  q_aero2_half_quad_pd_M->Sizes.checksums[2] = (1751541967U);
  q_aero2_half_quad_pd_M->Sizes.checksums[3] = (3075903846U);
  ...
  /* Initialize Sizes */
  q_aero2_half_quad_pd_M->Sizes.numContStates = (12);/* Number of continuous states */
  ...
  q_aero2_half_quad_pd_M->Sizes.numBlocks = (25);/* Number of blocks */
  q_aero2_half_quad_pd_M->Sizes.numBlockIO = (9);/* Number of block outputs */
  q_aero2_half_quad_pd_M->Sizes.numBlockPrms = (154);/* Sum of parameter "widths" */
